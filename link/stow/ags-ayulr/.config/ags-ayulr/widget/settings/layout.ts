...
export default [
   Page(
      ...
      Group(
         ...
         Row({ opt: font.name, title: "Font Name" }),
         Row({ opt: font.weight, title: "Font Weight" })
      )
   ),
   Page(
      "Bar",
      ...
      Group(
         ...
         Row({
            opt: b.workspaces.workspacesToIgnore,
      ...
      Group(
         ...
         Row({
            opt: b.media.charactersToStrip,
            title: "Strip Problematic Characters",
         })
      ),
      Group(
         "Battery",
