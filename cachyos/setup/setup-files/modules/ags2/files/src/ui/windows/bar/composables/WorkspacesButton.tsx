...
//    let labels = options.hyprland.workspaces.map((workspace) => {
//       return (<label label={`${workspace}`} />) as Gtk.Label;
//    });
//
//    const onFocusedWorkspaceChanged = (
//       label: Gtk.Label,
...
//
//    focusedWorkspaceAccessor.subscribe(() => {
//       labels.forEach((label, index) => onFocusedWorkspaceChanged(label, index));
//    });
//
//    return (
